        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-10 grid gap-6 grid-cols-2 sm:grid-cols-3 md:grid-cols-4 xl:grid-cols-6">
            {/* <!-- Card logo --> */}
              ...
              <Image src='/images/baner/123.jPG' alt="MESAroup" className="mx-auto max-h-12 object-contain " width={200} height={80} />
            
              <Image src='/images/baner/anh2.png' alt="ALife" className="mx-auto max-h-12 object-contain " width={200} height={80}  />

              <Image src='/images/baner/anh3.png' alt="Acrylic'Sai Gon" className="mx-auto max-h-12 object-contain " width={200} height={80}  />

              <Image src='/images/baner/anh4.png' alt="DIPRO" className="mx-auto max-h-12 object-contain"  width={200} height={80}  />

              <Image src='/images/baner/anh5.png' alt="TPBank" className="mx-auto max-h-12 object-contain " width={200} height={80}  />

              <Image src='/images/baner/anh6.png' alt="NI" className="mx-auto max-h-12 object-contain " width={200} height={80}  />

              <Image src='/images/baner/anh7.png' alt="Manulife" className="mx-auto max-h-12 object-contain " width={200} height={80}  />

              <Image src='/images/baner/anh8.png' alt="Techcombank" className="mx-auto max-h-12 object-contain " width={200} height={80}  />

              <Image src='/images/baner/anh9.png' alt="Kim Lng Phat" className="mx-auto max-h-12 object-contain " width={200} height={80}  />

              <Image src='/images/baner/anh10.png' alt="BIDV" className="mx-auto max-h-12 object-contain " width={200} height={80}  />

              <Image src='/images/baner/anh11.png' alt="HDBank" className="mx-auto max-h-12 object-contain " width={200} height={80}  /> 

              <Image src='/images/baner/anh12.png' alt="SGS" className="mx-auto max-h-12 object-contain " width={200} height={80}  />
            
          </div>

          {/* <!-- CTA Đăng ký --> */}
          <div className="mt-10 flex justify-center">
            <Link href="#dang-ky" className="inline-flex items-center rounded-xl bg-rose-500 px-6 py-3 text-white font-semibold shadow-lg hover:bg-rose-600 focus:outline-none focus-visible:ring-2 focus-visible:ring-rose-500">
              ĐĂNG KÝ NHẬN TƯ VẤN
            </Link>
          </div>
        </div>
